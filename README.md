...
3. [Tutorial 2: Command and Template Method Pattern](tutorial-2/README.md)
4. [Tutorial 3: Composite and Decorator Method Pattern](tutorial-3/README.md)
5. [Tutorial 4: Factory and Singleton Pattern](tutorial-4/README.md)
6. [Tutorial 5: RESTful API and Data Persistence](MyAc/README.md)
...
advprog-tutorial-2020

2. Note the clone (HTTPS) URL of the repository on your new project
3. Clone the repository to your local machine
    - `git clone https://gitlab.com/<YOURNAME>/advprog-tutorial-2020.git`
